...
class StructureController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('hrefBundle:structure:new.html.twig', array(
            'structure' => $structure,
    ...
    public function showAction(Structure $structure)
    {
        ...
        return $this->render('hrefBundle:structure:show.html.twig', array(
            'structure' => $structure,
    ...
    public function editAction(Request $request, Structure $structure)
    {
        ...
        return $this->render('hrefBundle:structure:edit.html.twig', array(
            'structure' => $structure,
